...
public class ListHandler extends CompareGetHandler
{
     ...
     */
    String markupVersionTable( String table, String listName, 
        String longNameId ) throws CompareException
    {
        ...
        if ( lines.length > 0 )
        {
            ...
            for ( int i=1;i<lines.length;i++ )
            {
                ...
                if ( cols.length > 2 )
                {
                    ...
                    throw new CompareException("ill-formed group/version record");
            }
            ...
            throw new CompareException( "invalid version table: no CRs");
        return doc.toString();
    }
    @Override
        ...
        HttpServletResponse response, String urn ) throws CompareException
    {
        ...
        try
        {
            if ( docid != null )
            {
                ...
                String markup = markupVersionTable( table, listName, longNameId );
